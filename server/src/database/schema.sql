...
('Premium Plan', 'Gói cao cấp có hỗ trợ nâng cao.', 199.00, 60, 'Theo dõi tiến trình, Phân tích nâng cao, Chiến lược bỏ thuốc cao cấp, Truy cập cộng đồng, Động lực hàng tuần, Được coach tư vấn qua chat và có thể đặt lịch')
